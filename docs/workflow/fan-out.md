...
| Any fan-out whose residual could be assembler-side | Add exactly one binutils rule-out | 1 | the assembler exonerated or implicated; either answer redirects the gcc agents |
