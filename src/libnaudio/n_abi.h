/*
 * naudio RSP audio command-list assembly macros.
 *
 * Each macro packs one Acmd microcode word-pair (w0/w1) for a synth pipeline
 * stage, inserting the operand fields with _SHIFTL bitfield writes.
 */
