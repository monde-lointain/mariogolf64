...
#define	NU_AU_MESG_MAX		2	/* MG64: 2 (asm-confirmed, was 4 in stock 2.05) */
...
#include <PR/libmus.h>
/* MG64 decomp: <PR/libmus_data.h> dropped -- it pulls <libaudio.h> -> <PR/mbi.h> (conflicts with
 * the project's libultra types) and no nualstl declaration here uses a libmus_data.h type. */
