...
+ S26 (seed 5) + S27 (seed 8) + S28 (seed 6) + S29 (seed 6) + S30-mirror (seed 1) + S32 (seed 10), the
running mirror-regime seed-velocity is 99 pt / 28 sprints = **3.54 pt/sprint** (S31 + S33 were pure classical, 0 mirror pts; S32 banked 10 mirror pts) — the warm-pool
