...
CFLAGS := -G 0 -mips3 -mgp32 -mfp32 -mno-abicalls -O2 -I include -I include/libultra -I include/libultra/internal -I include/libkmc -I include/libnusys -I include/libnaudio -DINCLUDE_ASM_USE_MACRO_INC -D_LANGUAGE_C -D_FINALROM
ifeq ($(NONMATCHING),1)
CFLAGS += -DNONMATCHING
endif
