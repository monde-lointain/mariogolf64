...
CFLAGS := -nostdinc -G 0 -mips2 -mgp32 -mfp32 -mno-abicalls -O2 -I include -I include/libultra -I include/libultra/internal -I include/libkmc -I include/libnusys -DINCLUDE_ASM_USE_MACRO_INC -D_LANGUAGE_C
ifeq ($(NONMATCHING),1)
CFLAGS += -DNONMATCHING
endif
